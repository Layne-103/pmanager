...
# Instructions
## Project manager requirement document

构建一个简单的，使用标签分类和管理ticket 的工具。
它基于postgres /vite/Tailwind/shadcn 做为前端。无需用户系统， 当前用户可以：
—  创建、编辑、删除、完成、取消完成 ticket 
-  添加、删除ticket 标签
-  按照不同的标签查看ticket list
-  按title search ticket
